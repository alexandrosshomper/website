  ...
  <>
    <ArticleSection>
      <ArticleSectionContent>
        ...
        <p>
          In this case study we’ll take a look at asana’s onboarding and
          activation flow.
        </p>
        <p>
          While we’ve identified two use cases (Personal Task Management and
          Team Collaboration), the case study reveals a strong bias towards the
          team use case, occasionally at the expense of individual users.
        </p>
        <p>
    ...
    <ArticleSection>
      <ArticleSectionContent>
        ...
        <p>
          On the website homepage it positions itself as a tool to connect any
          type of work with each other. This positioning is mainly focused on the
          buyer, the exec. They make the decision to purchase Asana on a big
          plan. For the actual users of Asana this positioning is very vague.
          Common for products with versatile use cases and aiming for enterprise
          customers.
        </p>
        <p>
        ...
        <p>
          ...
          different functions in a corporate. Marketing, Sales, Dev, HR, etc.
          which they can now afford compared to when they started — because
        ...
        <p>
          On the design side, the above the fold is very monotone. The CTA kind
          of blends in with the design. If everything has the same color, nothing
          is emphasized.
        </p>
        <p>
        ...
        <p>
          ...
          example reiterating the USP for marketing on the first signup screen
          when the user came from the marketing landing page.
        </p>
        ...
        <p>
          Leverage segmentation data to offer personalized templates and
          experiences.
        </p>
        ...
        <p>
          Create a more streamlined experience for personal users while
          maintaining team functionality.
        </p>

        <h3>First Experience</h3>
        <p>
          First screen is overloaded, personal users may feel overwhelmed by
