...
const CASE_STUDY_TYPE_CANONICAL_LABELS = {
  [CASE_STUDY_TYPES.ONBOARDING]: CASE_STUDY_TYPES.ONBOARDING,
  "Onboarding Case Study": CASE_STUDY_TYPES.ONBOARDING,
  [CASE_STUDY_TYPES.GENERAL]: CASE_STUDY_TYPES.GENERAL,
  "General Case Study": CASE_STUDY_TYPES.GENERAL,
};
...
const CASE_STUDY_METADATA = {
  ...
  "chatgpt-apps": {
    eyebrow: "Case Study",
    eyebrowColor1: "#10A37F",
    eyebrowColor2: "#A8F0DD",
    headline: "Booking vacation with ChatGPT Apps",
    copy: "Explore how ChatGPT Apps streamlines planning the perfect getaway.",
...
const mapCaseStudyType = (type) => {
  ...
  return CASE_STUDY_TYPE_CANONICAL_LABELS[trimmedType] || trimmedType;
};
