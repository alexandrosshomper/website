  ...
  <>
    ...
    <ArticleSection>
      <ArticleSectionContent>
        ...
        />
        <CaseSublineTwo subline="Knauf Digital’s mission is to digitalize Knauf’s business and digitize & centralize existing processes - for all Knauf brands and subsidiaries. " />
        <CaseCopy copy="Among many other, we developed an order overview app. A replacement for several email updates and/or phone conversations per week, for each brand separately. Details of every delivery (like ETA, materials in delivery, etc.) can change quickly. Just as quickly, the last updates could be not up-to-date anymore. Delivery-transparency is one of the main pain-points on a construction site." />
        <CaseCopy copy="Simultaneously, this means a lot of manual work for manufacturers aswell." />
        <CaseCopy copy="On the outside it looks rather simple, on the inside it proved to be a very challenging and complex initiative. An initiative with huge potential of improving internal efficiency and profitability, but also make our customers every-day life much easier." />
        <CaseCopy copy="It took two years, required alignment with several subsidiaries, and involved research within several countries, standardizing data and how it get’s displayed." />
        <ul>
          <li>
    ...
    <ArticleSection>
      <ArticleSectionContent>
        ...
        />
        <CaseCopy copy="We had a slight increase of Active users every month since the launch of the pilot, however the product struggled to grow as we’d expected. " />
    ...
    <ArticleSection>
      <ArticleSectionContent>
        ...
        <CaseCopy copy="I started to analyze the engagement of our features, and the correlation on user retention and engagement. What I found was one feature, the Delivery Notification, that seamed marginal with only 7% of user adoption." />
    ...
    <ArticleSection>
      <ArticleSectionContent>
        ...
        />
        <CaseCopy copy="Well, here is where things got interesting and took a turn. When we analyzed the data, we found that the Delivery Notifications were not triggering - at all." />
        <CaseCopy copy="This bug is of course bad news for the user experience, but it also means that we can't measure the impact of the Delivery Notifications on user activation, retention, and engagement." />
        <CaseSublineTwo subline="New questions" />
        <CaseCopy copy="But what does this mean for our analysis and hypothesis? What does this mean for our product? Where does the correlation between Delivery Notification and Activation, Retention, and Engagement come from?" />
        <CaseSublineTwo subline="The turn-around" />
        <CaseCopy copy="We found that the correlation between Delivery Notifications and user activation, retention, and engagement is not due to the Delivery Notifications themselves, but due to the users who adopt the Delivery Notifications - the power users." />
        <CaseCopy copy="A user behaviour analysis turned out to be a feature request survey. Our power users seam to like the idea of Delivery Notifications." />
        <CaseSublineTwo subline="Conclusion" />
        <CaseCopy copy="In conclusion, the importance of seeking correlations to overall performance and long-term retention when analyzing products and users can't be overstated. Yet, correlation is not causation." />
        <CaseCopy copy="It's crucial to identify key features that drive user engagement and retention, even if they initially seem marginal. Investigating these correlations provides valuable insights that can guide product improvement and optimization strategies." />
