...
import { CaseCardGrid } from "../../Layout/Grids";

const metaTitle = "myKnauf: Building a global construction app platform | Alexandros Shomper";
  ...
  <>
    ...
    <ArticleSection>
      <ArticleSectionContent>
        ...
        />
        <CaseCopy
          copy="After our explorations we continued with the development of several applications, each designed to address key challenges faced by specific customer types at construction sites, including planners, dealers, and applicators."
        />
        <CaseCopy
          copy="We believed that by tailoring our apps to these customer types, we would be able to provide the most effective solutions."
        />
        <CaseCopy
    ...
    <ArticleSection>
      <ArticleSectionContent>
        ...
        <CaseCopy
          copy="How can we reshape our apps offering to suite multiple customer types and generate synergies between the single apps?"
        />
      </ArticleSectionContent>
    </ArticleSection>
    ...
    <ArticleSection>
      <ArticleSectionContent>
        ...
        />
        <CaseCopy
          copy="Over the years we gathered a vast repository of research and interviews for the different customer types and products. With this new objective, we were able to look at the bigger picture. Discover bigger problems and opportunities."
        />
      </ArticleSectionContent>
    </ArticleSection>
    ...
    <ArticleSection>
      <ArticleSectionContent>
        ...
        <ul style={{ listStyleType: "circle" }}>
          <li>
            <b>Workspace:</b> Users experience inefficiencies when managing projects across multiple applications or services, each with its own interface and settings.
          </li>
          <li>
            <b>Team:</b> Users involved in construction projects often struggle with information silos, inefficient handoffs between different phases and customer types, and a lack of a centralized hub for project information.
          </li>
        </ul>
      </ArticleSectionContent>
    </ArticleSection>
